...
/**
 * UpdateSubsystemServlet for updating subsystems in glassfish
 * 
 * @author TangYong(tangyong@cn.fujitsu.com)
 */
@WebServlet(urlPatterns = "/UpdateSubsystemServlet")
public class UpdateSubsystemServlet extends HttpServlet {
